          ...
          <div className="headingCard">
               ...
               <CardsComponent as='cards' onHover='onHover'>
                      <div className="theme-toggle" as='cards' onHover='onHover'>
                        <Text as="h4"><span className="switchMode">Dark Mode <i  className="fa fa-toggle-on" aria-hidden="true"> </i> </span>   </Text>
        ...
        <div className="cards">
          ...
          <CardsComponent as='cards' onHover='onHover'>
                    <div className="cards__items cards__subscribers">
                        ...
                        {/* <ButtonsComponent card={true} placement="dark-mode"><SocialNetworks /></ButtonsComponent> */}
